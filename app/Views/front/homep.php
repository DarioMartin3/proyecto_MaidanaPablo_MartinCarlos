  ...
  <div class="d-grid gap-3 colum_responsive">
    <div class="p-3 "> <a href="#">
        <div class="card text-bg-dark float borde-card">
          ...
          <div class="card-img-overlay">
            <span class="span-overlay">Ropa Mujer</span>
          </div>
    ...
    <div class="p-3"> <a href="#">
        <div class="card text-bg-dark float borde-card">
          ...
          <div class="card-img-overlay">
            <span class="span-overlay">Ropa Hombre</span>
          </div>
    ...
    <div class="p-3"> <a href="#">
        <div class="card text-bg-dark float borde-card">
          ...
          <div class="card-img-overlay">
            <span class="span-overlay">Coleccion Otoño/Invierno</span>
          </div>
    ...
    <div class="p-3 ">
      <a href="#">
        <div class="card text-bg-dark float borde-card">
          ...
          <div class="card-img-overlay">
            <span class="span-overlay">Ver Todo</span>
          </div>
        </div>
      </a>
    </div>
